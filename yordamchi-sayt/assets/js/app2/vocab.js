...
(function () {
  ...
  var VOCAB_AI_GUIDE = [
    ...
    '',
    '## MOSLASHUVCHAN YOZ — qat\'iy shablon emas',
    '',
    'BARCHA yetti maydonni HAR so\'zga majburan to\'ldirma. So\'zning',
    'TURKUMIGA qarab qaysi maydon mos kelishini o\'zing hal qil:',
    '',
    '- **Fe\'l / ot / sifat / ravish** (mazmunli so\'z) — to\'liq boyitish',
    '  o\'rinli: Turkum, Shakllar, Sinonim/Antonim, Birikma — hammasi',
    '  foyda beradi.',
    '- **Yordamchi so\'z** (predlog/ko\'makchi: в, на, для, через; yuklama:',
    '  же, ли, бы; bog\'lovchi: и, но, потому что; olmosh: он, это) — bunday',
    '  so\'zda odatda Shakllar, Sinonim, Antonim, Birikma MA\'NOSIZ bo\'ladi.',
    '  Ularni bo\'sh qoldir, kuchlanib to\'ldirma. Bu turdagi so\'zga eng',
    '  ko\'p kerak bo\'ladigan narsa — u QANDAY ISHLATILISHI (qaysi',
    '  kelishik/holat bilan keladi) va Eslab qolish (majburiy qoladi).',
    '',
    'Qisqasi: har maydonni "bu so\'zga chindan foyda beradimi?" deb so\'rab',
    'to\'ldir. Foyda bermasa — QOLDIR, bo\'sh qator bilan joy band qilma.',
    '',
    '```markdown',
    '## 15. объясня́ть — tushuntirmoq',
    '',
    '> Turkum: fe\'l (NSV) — mukammal juft: объясни́ть',
    '',
    '> Talaffuz: объясня́ть (3-bo\'g\'inga urg\'u)',
    '',
    '> Shakllar: я объясня́ю, ты объясня́ешь, он объясня́ет',
    '',
    '> Sinonim: растолко́вывать (kamroq rasmiy, tushuntirib bermoq)',
    '',
    ...
    '- `Shakllar:` — BOSH SO\'ZDA YO\'Q shaklni yoz, borini takrorlama:',
    '    * Bosh so\'z INFINITIV bo\'lsa (объяснять) -> "я" shaklini yoz:',
    '      `Shakllar: я объясняю, ты объясняешь, он объясняет`',
    '    * Bosh so\'z "я" SHAKLIDA bo\'lsa (bu lug\'atda ko\'p uchraydi —',
    '      "я играю", "я пишу" kabi) -> INFINITIVNI yoz, "я" ni qaytarma:',
    '      so\'z "я объясняю" bo\'lsa -> `Shakllar: объяснять (infinitiv)`',
    '  Faqat CHALKASHTIRADIGAN/noodatiy shaklda yoz — muntazam',
    '  (-ать -> -аю/-аешь/-ает) qo\'shimcha shakl kerak emas, joy band qiladi.',
    '- `Sinonim:` / `Antonim:` — yaqin/qarama-qarshi 1-2 so\'z, HAR BIRINING',
    '  o\'zbekcha tarjimasi bilan qavs ichida: `растолковывать (tushuntirib',
    '  bermoq)`. Yolg\'iz rus/ingliz so\'zi yozilsa, o\'rganuvchi uni yana',
    '  qidirib o\'tirishi kerak bo\'ladi — bu maydonning maqsadini yo\'qqa',
    '  chiqaradi. Bo\'lmasa qoldir.',
