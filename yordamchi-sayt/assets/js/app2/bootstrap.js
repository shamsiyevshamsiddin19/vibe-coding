...
(function () {
  ...
  var IG_GRAD_DEF = '<defs><linearGradient id="ig-tab-grad" x1="0%" y1="100%" x2="100%" y2="0%">' +
  ...
  var TG_ICONS = {
    home: {
      ...
      fill: '<svg viewBox="0 0 24 24" width="24" height="24">' + IG_GRAD_DEF + '<path fill="url(#ig-tab-grad)" d="M12 2.5L2 9.8V20a2 2 0 0 0 2 2h5a1 1 0 0 0 1-1v-6h4v6a1 1 0 0 0 1 1h5a2 2 0 0 0 2-2V9.8L12 2.5z"/></svg>'
    },
    languages: {
      ...
      fill: '<svg viewBox="0 0 24 24" width="24" height="24">' + IG_GRAD_DEF + '<path fill="url(#ig-tab-grad)" d="M6.5 2H19a1 1 0 0 1 1 1v17.5a1 1 0 0 1-1 1H6.5A2.5 2.5 0 0 1 4 19V4.5A2.5 2.5 0 0 1 6.5 2zM6.5 17a2.5 2.5 0 0 0-2.5 2.5c0 .28.22.5.5.5H19v-3H6.5z"/></svg>'
    },
    kun: {
      ...
      fill: '<svg viewBox="0 0 24 24" width="24" height="24">' + IG_GRAD_DEF + '<path fill="url(#ig-tab-grad)" d="M19 4h-2V2.5a1 1 0 0 0-2 0V4H9V2.5a1 1 0 0 0-2 0V4H5a3 3 0 0 0-3 3v13a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3zm1 16a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V10h16v10z"/></svg>'
    },
    sport: {
      ...
      fill: '<svg viewBox="0 0 24 24" width="24" height="24">' + IG_GRAD_DEF + '<path fill="url(#ig-tab-grad)" d="M6 4a1 1 0 0 0-1 1v6H3a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h2v2a1 1 0 0 0 2 0v-6h10v6a1 1 0 0 0 2 0v-2h2a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1h-2V5a1 1 0 0 0-2 0v6H7V5a1 1 0 0 0-1-1z"/></svg>'
    },
    settings: {
