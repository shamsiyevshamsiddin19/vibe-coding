...
(function (root) {
  ...
  /* Mavzuni "o'rgandim" deb belgilash uchun qatorni shuncha ushlab turish.
     7000 ms juda uzun edi — barmoq tolib, odam qo'yib yuborardi.

     Bu qiymat CSS'dagi to'ladigan chiziq animatsiyasi bilan MOS bo'lishi
     shart. Ilgari ikkalasi alohida yozilgan edi (`learn.css` da `7s`), ya'ni
     birini o'zgartirib ikkinchisini unutish oson. Endi JS yagona manba:
     `--rm-hold` o'zgaruvchisi shu yerdan o'rnatiladi. */
  var HOLD_MS = 3000;
  try {
    document.documentElement.style.setProperty('--rm-hold', HOLD_MS + 'ms');
  } catch (e) {}
