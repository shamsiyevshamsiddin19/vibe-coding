...
CREATE TABLE IF NOT EXISTS foydalanuvchilar (
    ...
    ruxsatlar JSONB NOT NULL DEFAULT '["home", "languages", "fanlar", "stats"]'::jsonb,
...
-- Bir amalni IKKI MARTA bajarmaslik uchun.
-- Mijoz har yozuv amaliga barqaror `X-Idempotency-Key` beradi; javob yo'lda
-- yo'qolib mijoz qayta yuborsa, biz amalni qayta bajarmasdan SAQLANGAN
-- javobni qaytaramiz. `response_body` — aynan birinchi marta qaytarilgan JSON.
