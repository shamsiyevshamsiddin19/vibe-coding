...
// Google bilan kirish tugmasi (client) — matni tarjima qilinadi.
export default function AuthButton() {
  const t = useT();
  return (
    <button
      onClick={() => signIn("google")}
      className="flex items-center gap-2 rounded-lg bg-accent px-3 py-2 text-sm font-medium text-white transition hover:bg-accent-hover sm:px-4"
    >
      <GoogleIcon />
