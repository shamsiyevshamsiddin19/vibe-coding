TEXTS = {
    'uz': {
        ...
        'send_files': "Fayllarni yuboring. Tugatgach /done bosing."
    },
    'ru': {
        ...
        'send_files': "Отправьте файлы. После завершения нажмите /done."
    },
    'en': {
        ...
        'send_files': "Send files. Press /done when finished."
    }
}
